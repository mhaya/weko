...
WEKO_RECORDS_UI_BULK_UPDATE_FIELDS = {
    ...
    'licences': [{'id': 'license_free', 'name': 'é©óRì¸óÕ'},
                 {'id': 'license_0', 'name': 'Creative Commons : ï\é¶'},
                 {'id': 'license_1', 'name': 'Creative Commons : ï\é¶ - åpè≥'},
                 {'id': 'license_2', 'name': 'Creative Commons : ï\é¶ - â¸ïœã÷é~'},
                 {'id': 'license_3', 'name': 'Creative Commons : ï\é¶ - îÒâcóò'},
                 {'id': 'license_4', 'name': 'Creative Commons : ï\é¶ - îÒâcóò - åpè≥'},
                 {'id': 'license_5', 'name': 'Creative Commons : ï\é¶ - îÒâcóò - â¸ïœã÷é~'}]
}
